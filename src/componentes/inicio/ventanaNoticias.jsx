...
const VentanaNoticias = ({ noticias, eventos }) => {
  return (
    <div>
      <div className="relative ml-8 mb-8 w-[85rem] h-[38rem]">
        <div className="absolute z-50">
          <div className="">
            <div className="flex w-[85rem] h-[38rem] border-2 border-black bg-[#EF7E98]">
                ...
                <div className="relative h-[27rem] ml-24 ">
                  ...
                  <div className="absolute bottom-[-3rem] left-[-5rem] w-[22rem] h-[16rem] bg-[#F9D1FF] border-[1px] border-black">
                    <div className="relative w-full h-full">
                      ...
                      <div className="text-sm p-2">{noticias.descripcion}</div>
        ...
        <div className="absolute w-[85rem] h-[38rem] border-2 z-40 border-black top-[0.3rem] left-[0.3rem] bg-[#BF9AF3] "></div>
        <div className="absolute w-[85rem] h-[38rem] border-2 z-30 border-black top-[0.6rem] left-[0.6rem] bg-[#BF9AF3] "></div>
      </div>
    </div>
  );
};
