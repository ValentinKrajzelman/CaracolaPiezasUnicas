  ...
  return (
    <div>
      <div className="flex justify-center my-[10rem]">
        <div className="relative w-[83rem] h-[36rem]">
              ...
              <div className="grow flex items-center justify-evenly">
                {talleres.map((taller) => {
                  return (
                    <div
                      key={taller._id}
                      className="relative w-[17rem] h-[25rem]"
                    >
                        ...
                        <div className="flex flex-col h-full">
                          ...
                          <div className="flex justify-end">
                            <div className="relative h-[5rem]">
                              ...
                              <div className="flex text-l font-medium w-[4rem] h-[2.5rem] justify-center items-center pl-[0.5rem] m-2 border-2 border-black underline bg-black absolute z-0 right-[-0.15rem] bottom-[-0.15rem]"> </div>
                            </div>
                          </div>
                        </div>
                      </div>
